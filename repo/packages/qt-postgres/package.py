...
class QtPostgres(Package):
	...
	config_args.append('-sql-psql')
	config_args.append("PSQL_INCDIR=%s" % spec["postgresql"].prefix.include )
        config_args.append("PSQL_LIBDIR=%s" % spec["postgresql"].prefix.lib )
